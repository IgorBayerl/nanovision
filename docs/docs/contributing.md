...
This project follows a [Code of Conduct](https://github.com/IgorBayerl/nanovision?tab=coc-ov-file). By participating, you agree to abide by it.
...
![diagram](imgs/nanovision-flow.png)
...
- Discussions: `open an issue for discussions`
