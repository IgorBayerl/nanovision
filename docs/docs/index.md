...
Please see [CONTRIBUTING.md](https://github.com/IgorBayerl/nanovision/blob/main/CONTRIBUTING.md) for details on setting up the dev environment (Devcontainer included).
